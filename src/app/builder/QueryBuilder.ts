...
class QueryBuilder<T> {
  ...
  filter() {
    ...
    // Filtering
    const excludeFields = ['searchTerm', 'sortBy', 'limit', 'page', 'fields','minPrice','maxPrice','tags','level','startDate','endDate','sales','toDate','fromDate','types','sizes','fragrances','productStock','undefined','bloomToDate','bloomFromDate','isAvailable'];
